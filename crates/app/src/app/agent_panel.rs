...
use termide_agent_core::{
    build_system_prompt, discover_context_files, Decision, ModelSpec, PromptOptions,
};
...
impl App {
    ...
    pub(in crate::app) fn handle_open_agent(&mut self) -> Result<()> {
        ...
        // Agent sessions live beside the layout session of the same project,
        // under `<data>/sessions/<project>/agent/`.
